...
public interface ReportingService {
    ...
    void getClothReport(Long customerId, Long locationId, Integer orderNo, Long barcode, Date deliverDateFrom,
                        ...
                        Integer type, Date locationDate, Long designId, Double gauge, String setting, Boolean reOrder, String week, Long colorId, HttpServletResponse httpServletResponse);
