...
//
//    @Autowired
//    public ShawlReportServiceImpl(ShawlInventoryRepositoryCustom shawlEntryRepository) {
...
//        List<ShawlInventoryResource> entryResources = shawlEntryRepository.getAllResources(locationId, sizeId, yarnId, customerId, colorId, shawlId, entryDateFrom, entryDateTo, exportDateFrom, exportDateTo);
