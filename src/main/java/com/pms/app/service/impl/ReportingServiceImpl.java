...
public class ReportingServiceImpl implements ReportingService {
    ...
    public void createOrderInvoice(Long orderNo, Long customerId, HttpServletResponse httpServletResponse) {
        ...
        List<ClothInvoiceResource> resources = clothRepository.findClothesForInvoice(orderNo.intValue(), customerId);
        if (resources == null || resources.isEmpty()) {
            ...
            Cell priceHeader = headerRow.createCell(7);
            priceHeader.setCellValue("Price");
            priceHeader.setCellStyle(style);

            Cell printAmountHeader = headerRow.createCell(8);
    ...
    public void createShippingList(String shippingNumber, HttpServletResponse httpServletResponse) {
        List<ClothResource> clothResources = clothRepository.findShippedCloth(shippingNumber);
